...
This page shows what a readable MCP Preflight result looks like.

The values and file paths below are placeholders, but the structure is real: verdict first, then findings, then the next step.
...
Move credentials out of the URL. Use a safer auth path with the smallest scope that still works.
...
- The report is meant to stay readable before it becomes something you hand off or gate on.
