...
## Published guides
- [Quick preflight read: the official filesystem reference server setup](guides/2026-03-07-official-filesystem-server-setup.md)
- [How to secure `mcp.json` without turning it into ceremony](guides/2026-03-08-secure-mcp-json-without-ceremony.md)
- [Tool poisoning language that looks harmless until you read it closely](guides/2026-03-08-tool-poisoning-language-that-looks-harmless.md)
